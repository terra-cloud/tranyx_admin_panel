  ...
  Future<void> _deletePromo(BuildContext context, String code) async {
    ...
    try {
      ...
      final usersWithPromo = await firestore
          .collection('users')
          .where('activePromoCode', isEqualTo: code)
          .get();
    ...
    return div(classes: 'flex-1 p-6 md:p-8 flex flex-col gap-6 max-w-7xl mx-auto w-full bg-[#eff2f0]', [
      ...
      div(classes: 'flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200/50 pb-5', [
        div(classes: 'flex flex-col gap-1', [
          h1(classes: 'text-xl font-black tracking-tight text-zinc-900', [text('Promotions Console')]),
          p(classes: 'text-xs text-zinc-400 font-medium', [
            text('Create and manage discount codes, user limits, and targeted role campaigns.'),
          ]),
        ]),
      ]),
      ...
      div(classes: 'grid grid-cols-1 lg:grid-cols-3 gap-6', [
        ...
        div(
          ...
          classes: 'lg:col-span-1 p-6 bg-white border border-zinc-200/50 rounded-[28px] shadow-sm flex flex-col gap-5 h-fit',
          [
            h2(classes: 'text-sm font-black text-zinc-900 border-b border-zinc-150 pb-2', [text('Create Promotion')]),
          ...
          if (_successMessage != null)
            div(classes: 'p-3 bg-emerald-50 text-[#0fa958] rounded-xl text-xs font-semibold border border-emerald-200', [
          ...
          div(classes: 'flex flex-col gap-4', [
            // Code Input
            div(classes: 'flex flex-col gap-1', [
              label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Promo Code')]),
              input(
                classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500 uppercase',
                attributes: {
                  'type': 'text',
            ...
            div(classes: 'flex flex-col gap-1', [
              label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Applicable To')]),
              select(
                classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500',
                events: {
                  'change': (e) => setState(() => _applicableTo = (e.target as dynamic).value as String),
                },
                [
                  option(value: 'both', selected: _applicableTo == 'both', [text('Both Services & Rentals')]),
                  option(value: 'rentals', selected: _applicableTo == 'rentals', [text('Rentals (Vehicles & Properties)')]),
                  option(value: 'services', selected: _applicableTo == 'services', [text('Services (Gigs)')]),
                ],
              ),
            ]),
            ...
            div(classes: 'grid grid-cols-2 gap-3', [
              div(classes: 'flex flex-col gap-1', [
                label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Type')]),
                select(
                  classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500',
                  events: {
                  ...
                  [
                    option(value: 'flat', selected: _discountType == 'flat', [text('Flat (₱)')]),
                    option(value: 'percentage', selected: _discountType == 'percentage', [text('Percentage (%)')]),
                  ],
                ),
              ]),
              div(classes: 'flex flex-col gap-1', [
                label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Value')]),
                input(
                  classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500',
                  attributes: {
                    'type': 'number',
            ...
            div(classes: 'grid grid-cols-2 gap-3', [
              div(classes: 'flex flex-col gap-1', [
                label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Expiration Date')]),
                input(
                  classes: 'w-full px-4 py-2 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500',
                  attributes: {
                    'type': 'date',
              ...
              div(classes: 'flex flex-col gap-1', [
                label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Max Users Limit')]),
                input(
                  classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold focus:outline-none focus:border-indigo-500',
                  attributes: {
                    'type': 'number',
            ...
            div(classes: 'flex flex-col gap-1.5', [
              label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Targeted Roles')]),
              div(classes: 'grid grid-cols-2 gap-2 bg-zinc-50 p-3 border border-zinc-200 rounded-xl', [
                div(classes: 'flex items-center gap-2', [
                  ...
                  span(classes: 'text-xs text-zinc-700 font-semibold', [text('Renter')]),
                ]),
                div(classes: 'flex items-center gap-2', [
                  input(
                    classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  ...
                  span(classes: 'text-xs text-zinc-700 font-semibold', [text('Host/Owner')]),
                ]),
                div(classes: 'flex items-center gap-2', [
                  input(
                    classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  ...
                  span(classes: 'text-xs text-zinc-700 font-semibold', [text('Employer')]),
                ]),
                div(classes: 'flex items-center gap-2', [
                  input(
                    classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  ...
                  span(classes: 'text-xs text-zinc-700 font-semibold', [text('Nyxian')]),
                ]),
              ]),
            ]),
            ...
            div(classes: 'flex flex-col gap-1', [
              label(classes: 'text-[10px] font-black text-zinc-400 uppercase tracking-wider', [text('Eligible User UIDs (Optional)')]),
              textarea(
                placeholder: 'e.g., uid1, uid2, uid3 (leave empty for all)',
                classes: 'w-full px-4 py-2.5 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-semibold focus:outline-none focus:border-indigo-500 h-16 resize-none',
                events: {
                  'input': (e) => setState(() => _eligibleUserUidsStr = (e.target as dynamic).value as String),
                },
                [_eligibleUserUidsStr.isNotEmpty ? text(_eligibleUserUidsStr) : text('')],
              ),
            ]),
            ...
            div(classes: 'flex flex-col gap-2.5 bg-zinc-50 p-4 border border-zinc-200 rounded-xl', [
              div(classes: 'flex items-center justify-between', [
                div(classes: 'flex flex-col', [
                  span(classes: 'text-xs font-bold text-zinc-800', [text('Auto Apply')]),
                  span(classes: 'text-[9px] text-zinc-400 font-medium', [text('Automatically apply at checkout')]),
                ]),
                input(
                  classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  attributes: {
              ...
              div(classes: 'flex items-center justify-between border-t border-zinc-200/50 pt-2.5', [
                div(classes: 'flex flex-col', [
                  span(classes: 'text-xs font-bold text-zinc-800', [text('Single Use Only')]),
                  span(classes: 'text-[9px] text-zinc-400 font-medium', [text('Limit to one activation per user')]),
                ]),
                input(
                  classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  attributes: {
              ...
              div(classes: 'flex items-center justify-between border-t border-zinc-200/50 pt-2.5', [
                div(classes: 'flex flex-col', [
                  span(classes: 'text-xs font-bold text-zinc-800', [text('Subscribed Users Only')]),
                  span(classes: 'text-[9px] text-zinc-400 font-medium', [text('Only premium subscribed accounts')]),
                ]),
                input(
                  classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  attributes: {
              ...
              div(classes: 'flex items-center justify-between border-t border-zinc-200/50 pt-2.5', [
                div(classes: 'flex flex-col', [
                  span(classes: 'text-xs font-bold text-zinc-800', [text('Hybrid Accounts Only')]),
                  span(classes: 'text-[9px] text-zinc-400 font-medium', [text('Only hybrid PRO accounts')]),
                ]),
                input(
                  classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  attributes: {
              ...
              div(classes: 'flex items-center justify-between border-t border-zinc-200/50 pt-2.5', [
                div(classes: 'flex flex-col', [
                  span(classes: 'text-xs font-bold text-zinc-800', [text('Is Active')]),
                  span(classes: 'text-[9px] text-zinc-400 font-medium', [text('Enable/disable globally')]),
                ]),
                input(
                  classes: 'h-4 w-4 text-indigo-500 rounded border-zinc-300 focus:ring-indigo-500',
                  attributes: {
            ...
            button(
              ...
              classes: 'w-full py-3 bg-black hover:bg-zinc-800 disabled:bg-zinc-300 text-white rounded-2xl text-xs font-black tracking-wider uppercase transition-all shadow-md shadow-black/10 mt-2',
              [text(_isSubmitting ? 'Posting...' : 'Create Promo Code')],
            ),
          ]),
        ]),
        ...
        div(classes: 'lg:col-span-2 flex flex-col gap-4', [
          promosAsync.when(
            data: (promosList) {
              if (promosList.isEmpty) {
                return div(
                  ...
                  [
                    ...
                    h3(classes: 'text-sm font-bold text-zinc-900', [text('No Promotions Configured')]),
                    p(classes: 'text-xs text-zinc-500 mt-1', [text('Add your first promotion code using the creation form.')]),
                  ],
                );
              }
              ...
              return div(classes: 'flex flex-col gap-4 overflow-y-auto max-h-[750px] pr-2 no-scrollbar', [
                for (final promo in promosList)
                  div(
                    classes: 'p-5 rounded-[24px] bg-white border border-zinc-200/50 flex flex-col gap-4 shadow-[0_8px_30px_rgba(0,0,0,0.01)] hover:border-zinc-300 transition-all',
                    [
                      ...
                      div(classes: 'flex items-center justify-between', [
                        div(classes: 'flex items-center gap-3', [
                          span(
                            classes: 'text-sm font-black tracking-wider px-3.5 py-1.5 rounded-xl border border-zinc-200/50 '
                                '${promo.isActive ? "bg-indigo-50/50 text-indigo-600 border-indigo-100" : "bg-zinc-50 text-zinc-400"}',
                            [text(promo.code)],
                          ),
                          span(
                            classes: 'text-[10px] font-extrabold px-3 py-1 rounded-full border '
                        ...
                        div(classes: 'flex items-center gap-1.5', [
                          button(
                            ...
                            classes: 'px-3.5 py-1.5 rounded-lg border text-[10px] font-black transition-all '
                          ...
                          button(
                            ...
                            classes: 'p-1.5 rounded-lg border border-red-200 bg-red-50/50 text-red-500 hover:bg-red-100/50 transition-all text-xs',
                            [text('🗑️')],
                          ),
                        ]),
                      ]),
                      ...
                      div(classes: 'grid grid-cols-2 sm:grid-cols-4 gap-4 bg-zinc-50 p-4 border border-zinc-150 rounded-2xl', [
                        div(classes: 'flex flex-col gap-0.5', [
                          span(classes: 'text-[9px] font-bold text-zinc-400 uppercase tracking-wide', [text('Discount Value')]),
                        ...
                        div(classes: 'flex flex-col gap-0.5', [
                          span(classes: 'text-[9px] font-bold text-zinc-400 uppercase tracking-wide', [text('Activations')]),
                          span(classes: 'text-xs font-black text-zinc-800', [
                            text('${promo.usedCount}${promo.maxUsers != null ? " / ${promo.maxUsers}" : ""}')
                          ]),
                        ]),
                        div(classes: 'flex flex-col gap-0.5', [
                          span(classes: 'text-[9px] font-bold text-zinc-400 uppercase tracking-wide', [text('Expiration Date')]),
                          span(classes: 'text-xs font-black text-zinc-800', [
                            text(promo.expirationDate != null
                                ? '${promo.expirationDate!.year}-${promo.expirationDate!.month.toString().padLeft(2, '0')}-${promo.expirationDate!.day.toString().padLeft(2, '0')}'
                                : 'Never'),
                          ]),
                        ]),
                        div(classes: 'flex flex-col gap-0.5', [
                          span(classes: 'text-[9px] font-bold text-zinc-400 uppercase tracking-wide', [text('Status')]),
                          span(
                            classes: 'text-xs font-black '
                                '${promo.isActive ? "text-[#0fa958]" : "text-zinc-450"}',
                            [text(promo.isActive ? 'Active' : 'Disabled')],
                          ),
                        ]),
                      ]),
                      ...
                      div(classes: 'flex flex-wrap gap-2', [
                        if (promo.isAutoApply)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-emerald-50 border border-emerald-100 rounded text-emerald-600', [
                            text('Auto Apply')
                          ]),
                        if (promo.isSingleUsePerUser)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-blue-50 border border-blue-100 rounded text-blue-600', [
                            text('Single Use')
                          ]),
                        if (promo.onlyForSubscribed)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-purple-50 border border-purple-100 rounded text-purple-600', [
                            text('Premium Only')
                          ]),
                        if (promo.onlyForHybrid)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-amber-50 border border-amber-100 rounded text-amber-600', [
                            text('Hybrid Only')
                          ]),
                        if (promo.applicableRoles.isNotEmpty)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-zinc-100 border border-zinc-200 rounded text-zinc-600', [
                            text('Roles: ${promo.applicableRoles.join(', ')}')
                          ]),
                        if (promo.eligibleUserUids.isNotEmpty)
                          span(classes: 'text-[9px] font-bold px-2 py-0.5 bg-zinc-100 border border-zinc-200 rounded text-zinc-600', [
                            text('Targeted: ${promo.eligibleUserUids.length} users')
                          ]),
                      ]),
                    ],
                  ),
            ...
            error: (err, _) => div(
              ...
              [text('Error loading Promos list: $err')],
            ),
          ),
        ]),
      ]),
