...
class _DashboardState extends State<Dashboard> {
  ...
  Component _buildAdminActiveAgentsTrackerSection(List<StaffRosterMember> roster) {
    ...
    return div(
      ...
      [
        // Top Header Row
        div(classes: 'flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-100 pb-3.5', [
          div(classes: 'flex flex-col gap-0.5', [
            div(classes: 'flex items-center gap-2', [
              h3(classes: 'text-xs font-bold text-zinc-900', [Component.text('Agent Presence & Live Operations Tracker')]),
              span(
                classes: 'px-2 py-0.5 rounded-full text-[9px] font-extrabold uppercase tracking-wider bg-emerald-50 text-[#0fa958] border border-emerald-200/60 flex items-center gap-1.5',
                [
            ...
            p(classes: 'text-[11px] text-zinc-400 font-medium', [
          ...
          div(classes: 'flex items-center gap-1.5 flex-wrap', [
            ...
            a(
              href: '/users',
              classes: 'text-[10px] font-bold text-zinc-500 hover:text-black transition-colors no-underline px-2 py-1 rounded-lg hover:bg-zinc-100',
              [Component.text('Manage Staff →')],
            ),
          ]),
        ]),

        // 5-Card Full-Width KPI Metrics Strip
        div(classes: 'grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3', [
          div(
            classes: 'bg-[#fcfdfc] border border-zinc-200/60 rounded-2xl p-3 flex flex-col gap-1',
            [
              span(classes: 'text-[8.5px] font-extrabold text-zinc-400 uppercase tracking-wider', [
                Component.text('Total Staff'),
              ]),
              div(classes: 'flex items-baseline justify-between', [
                h4(classes: 'text-lg font-black text-zinc-900', [Component.text(roster.length.toString())]),
                span(classes: 'text-[9.5px] text-zinc-400 font-bold', [Component.text('Agents')]),
              ]),
            ],
          ),
          div(
            classes: 'bg-emerald-50/50 border border-emerald-200/60 rounded-2xl p-3 flex flex-col gap-1',
            [
              span(classes: 'text-[8.5px] font-extrabold text-emerald-700 uppercase tracking-wider', [
                Component.text('Waiting / Available'),
              ]),
              div(classes: 'flex items-baseline justify-between', [
                h4(classes: 'text-lg font-black text-emerald-600', [Component.text(waitingCount.toString())]),
                span(classes: 'text-[9.5px] text-emerald-600 font-bold', [Component.text('Ready')]),
              ]),
            ],
          ),
          div(
            classes: 'bg-amber-50/50 border border-amber-200/60 rounded-2xl p-3 flex flex-col gap-1',
            [
              span(classes: 'text-[8.5px] font-extrabold text-amber-700 uppercase tracking-wider', [
                Component.text('Active in Tasks'),
              ]),
              div(classes: 'flex items-baseline justify-between', [
                h4(classes: 'text-lg font-black text-amber-600', [Component.text(busyCount.toString())]),
                span(classes: 'text-[9.5px] text-amber-600 font-bold', [Component.text('Busy')]),
              ]),
            ],
          ),
          div(
            classes: 'bg-orange-50/50 border border-orange-200/60 rounded-2xl p-3 flex flex-col gap-1',
            [
              span(classes: 'text-[8.5px] font-extrabold text-orange-700 uppercase tracking-wider', [
                Component.text('Away (AFK)'),
              ]),
              div(classes: 'flex items-baseline justify-between', [
                h4(classes: 'text-lg font-black text-orange-600', [Component.text(awayCount.toString())]),
                span(classes: 'text-[9.5px] text-orange-600 font-bold', [Component.text('Idle')]),
              ]),
            ],
          ),
          div(
            classes: 'bg-zinc-50 border border-zinc-200/60 rounded-2xl p-3 flex flex-col gap-1',
            [
              span(classes: 'text-[8.5px] font-extrabold text-zinc-400 uppercase tracking-wider', [
                Component.text('Offline'),
              ]),
              div(classes: 'flex items-baseline justify-between', [
                h4(classes: 'text-lg font-black text-zinc-500', [Component.text(offlineCount.toString())]),
                span(classes: 'text-[9.5px] text-zinc-400 font-bold', [Component.text('Away')]),
              ]),
            ],
          ),
        ]),
        ...
        if (filteredList.isEmpty)
          div(classes: 'py-10 text-center flex flex-col items-center gap-2', [
            span(classes: 'text-xl', [Component.text('🔍')]),
            span(classes: 'text-[11px] font-bold text-zinc-600', [Component.text('No agents match this filter status')]),
          ])
        else
          div(classes: 'overflow-x-auto w-full', [
            div(classes: 'min-w-[700px] flex flex-col', [
              ...
              for (final agent in filteredList)
                div(
                  classes:
                      'grid grid-cols-12 items-center py-2 px-3 border-b border-zinc-50 last:border-0 hover:bg-zinc-50/70 rounded-xl transition-colors',
                  [
                    // Agent Avatar & Name
                    div(classes: 'col-span-5 flex items-center gap-2.5 min-w-0 pr-3', [
                      div(
                        classes: 'relative w-7 h-7 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center font-black text-zinc-700 text-[9px] flex-shrink-0 overflow-hidden shadow-sm',
                        [
                      ...
                      div(classes: 'flex flex-col min-w-0 leading-tight', [
                        span(classes: 'text-[11px] font-bold text-zinc-900', [Component.text(agent.name)]),
                        span(classes: 'text-[9px] text-zinc-400 font-normal truncate mt-0.5', [Component.text(agent.email)]),
                      ]),
                    ]),
                    ...
                    div(classes: 'col-span-2 flex justify-center', [
                      span(
                        classes: 'text-[8.5px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-md bg-zinc-100/70 text-zinc-600',
                        [Component.text(agent.role)],
                      ),
                    ]),

                    // Status Pill (Elegant Micro-Pill)
                    div(classes: 'col-span-2 flex justify-center', [
                      span(
                        classes:
                            'inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[8.5px] font-bold uppercase tracking-wider border '
                    ...
                    // Current Task / Activity (Elegant Typography)
                    ...
                    div(classes: 'col-span-1 text-right', [
                      span(
                        classes: 'text-[9px] font-normal text-zinc-400',
                        [
  ...
  Component _rosterFilterButton(String key, String labelText) {
    ...
    return button(
      ...
      classes:
          'px-2 py-0.5 rounded-lg text-[9.5px] font-bold transition-all border-0 cursor-pointer '
